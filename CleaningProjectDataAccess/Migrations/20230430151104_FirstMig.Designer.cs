...
namespace CleaningProjectDataAccess.Migrations
{
    ...
    [Migration("20230430151104_FirstMig")]
            ...
            modelBuilder.Entity("CleaningProjectModel.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AdminID = 1,
                            CreatedDate = new DateTime(2023, 4, 30, 18, 11, 4, 49, DateTimeKind.Local).AddTicks(848),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "admin",
                            Password = "96321.",
            ...
            modelBuilder.Entity("CleaningProjectModel.Entities.Hakkimizda", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            HakkimizdaID = 1,
                            CreatedDate = new DateTime(2023, 4, 30, 18, 11, 4, 50, DateTimeKind.Local).AddTicks(5482),
                            ImagePath = "path",
                            IsActive = true,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("CleaningProjectModel.Entities.Hizmet", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            HizmetID = 1,
                            CreatedDate = new DateTime(2023, 4, 30, 18, 11, 4, 49, DateTimeKind.Local).AddTicks(1291),
            ...
            modelBuilder.Entity("CleaningProjectModel.Entities.Ilce", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IlceID = 1,
                            CreatedDate = new DateTime(2023, 4, 30, 18, 11, 4, 49, DateTimeKind.Local).AddTicks(1722),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Merkez"
                        });
            ...
            modelBuilder.Entity("CleaningProjectModel.Entities.Iletisim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IletisimID = 1,
                            Address = "uzun adress",
                            CreatedDate = new DateTime(2023, 4, 30, 18, 11, 4, 50, DateTimeKind.Local).AddTicks(6175),
                            IsActive = true,
                            IsDeleted = false,
                            Mail = "rey@gmail.com",
            ...
            modelBuilder.Entity("CleaningProjectModel.Entities.IsBasvuru", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CV = "blala bala blaaa",
                            CreatedDate = new DateTime(2023, 4, 30, 18, 11, 4, 49, DateTimeKind.Local).AddTicks(2154),
            ...
            modelBuilder.Entity("CleaningProjectModel.Entities.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PersonnelID = 1,
                            Address = "Aksaray",
                            CreatedDate = new DateTime(2023, 4, 30, 18, 11, 4, 49, DateTimeKind.Local).AddTicks(3117),
            ...
            modelBuilder.Entity("CleaningProjectModel.Entities.PersonnelHizmet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TeklifID = 1,
                            PersonelID = 1,
                            CreatedDate = new DateTime(2023, 4, 30, 18, 11, 4, 49, DateTimeKind.Local).AddTicks(9738),
                            IsActive = true,
                            IsDeleted = false,
                            Price = 5,
            ...
            modelBuilder.Entity("CleaningProjectModel.Entities.SosyalMedya", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SocialID = 1,
                            CreatedDate = new DateTime(2023, 4, 30, 18, 11, 4, 50, DateTimeKind.Local).AddTicks(5897),
            ...
            modelBuilder.Entity("CleaningProjectModel.Entities.TeklifAl", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TeklifID = 1,
                            Address = "adress",
                            CreatedDate = new DateTime(2023, 4, 30, 18, 11, 4, 50, DateTimeKind.Local).AddTicks(5123),
                            IsActive = true,
                            IsDeleted = false,
                            Mail = "nur@gmail.com",
                            Name = "Nur",
